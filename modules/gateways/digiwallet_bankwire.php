 ...
 * @return array
 */
function digiwallet_bankwire_MetaData()
{
    return array(
        'DisplayName' => 'Digiwallet - Bankwire - Overschrijving',
 ...
 * @return array
 */
function digiwallet_bankwire_config()
{
    ...
    return array(
        ...
        'FriendlyName' => array(
            'Type' => 'System',
            'Value' => sprintf($dwLang['digiwallet']['default_method_name'], 'Bankwire - Overschrijving'),
        ),
        'rtlo' => array(
 ...
 * @return string
 */
function digiwallet_bankwire_link($params)
{
 ...
 */
function digiwallet_bankwire_refund($params)
{
...
add_hook('ShoppingCartValidateCheckout', 1, function($vars) {
    ...
    if($vars['paymentmethod'] == $gatewayModuleName) {
        ...
        if (empty($gatewayParams['rtlo'])) {
            return [
                sprintf($dwLang['digiwallet']['error_missing_rtlo'], 'Bankwire'),
            ];
        }
    }
});