 ...
 * @return array
 */
function digiwallet_bancontact_MetaData()
{
    return array(
        'DisplayName' => 'Digiwallet - Bancontact',
 ...
 * @return array
 */
function digiwallet_bancontact_config()
{
    ...
    return array(
        ...
        'FriendlyName' => array(
            'Type' => 'System',
            'Value' => sprintf($dwLang['digiwallet']['default_method_name'], 'Bancontact'),
        ),
        'rtlo' => array(
 ...
 * @return string
 */
function digiwallet_bancontact_link($params)
{
 ...
 */
function digiwallet_bancontact_refund($params)
{
...
add_hook('ShoppingCartValidateCheckout', 1, function($vars) {
    ...
    if($vars['paymentmethod'] == $gatewayModuleName) {
        ...
        if (empty($gatewayParams['rtlo'])) {
            return [
                sprintf($dwLang['digiwallet']['error_missing_rtlo'], 'Bancontact'),
            ];
        }
    }
});