 ...
 * @return array
 */
function digiwallet_creditcard_MetaData()
{
    return array(
        'DisplayName' => 'Digiwallet - CreditCard',
 ...
 * @return array
 */
function digiwallet_creditcard_config()
{
    ...
    return array(
        ...
        'FriendlyName' => array(
            'Type' => 'System',
            'Value' => sprintf($dwLang['digiwallet']['default_method_name'], 'CreditCard'),
        ),
        'rtlo' => array(
 ...
 * @return string
 */
function digiwallet_creditcard_link($params)
{
 ...
 */
function digiwallet_creditcard_refund($params)
{
...
add_hook('ShoppingCartValidateCheckout', 1, function($vars) {
    ...
    if($vars['paymentmethod'] == $gatewayModuleName) {
        ...
        if (empty($gatewayParams['rtlo'])) {
            return [
                sprintf($dwLang['digiwallet']['error_missing_rtlo'], 'CreditCard'),
            ];
        }
    }
});