 ...
 * @return array
 */
function digiwallet_ideal_config()
{
 ...
 * @return string
 */
function digiwallet_ideal_link($params)
{
 ...
 */
function digiwallet_ideal_refund($params)
{
...
add_hook('ShoppingCartValidateCheckout', 1, function($vars) {
    ...
    if($vars['paymentmethod'] == $gatewayModuleName) {
        ...
        if (empty($gatewayParams['rtlo'])) {
            return [
                sprintf($dwLang['digiwallet']['error_missing_rtlo'], 'Ideal'),
            ];
        }
    }
});