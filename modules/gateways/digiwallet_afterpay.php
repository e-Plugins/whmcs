 ...
 * @return array
 */
function digiwallet_afterpay_MetaData()
{
    return array(
        'DisplayName' => 'Digiwallet - AfterPay',
 ...
 * @return array
 */
function digiwallet_afterpay_config()
{
    ...
    return array(
        ...
        'FriendlyName' => array(
            'Type' => 'System',
            'Value' => sprintf($dwLang['digiwallet']['default_method_name'], 'AfterPay'),
        ),
        'rtlo' => array(
 ...
 * @return string
 */
function digiwallet_afterpay_link($params)
{
 ...
 */
function digiwallet_afterpay_refund($params)
{
...
add_hook('ShoppingCartValidateCheckout', 1, function($vars) {
    ...
    if($vars['paymentmethod'] == $gatewayModuleName) {
        ...
        if (empty($gatewayParams['rtlo'])) {
            return [
                sprintf($dwLang['digiwallet']['error_missing_rtlo'], 'AfterPay'),
            ];
        }
    }
});