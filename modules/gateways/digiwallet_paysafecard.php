 ...
 * @return array
 */
function digiwallet_paysafecard_MetaData()
{
    return array(
        'DisplayName' => 'Digiwallet - PaysafeCard',
 ...
 * @return array
 */
function digiwallet_paysafecard_config()
{
    ...
    return array(
        ...
        'FriendlyName' => array(
            'Type' => 'System',
            'Value' => sprintf($dwLang['digiwallet']['default_method_name'], 'PaysafeCard'),
        ),
        'rtlo' => array(
 ...
 * @return string
 */
function digiwallet_paysafecard_link($params)
{
 ...
 */
function digiwallet_paysafecard_refund($params)
{
...
add_hook('ShoppingCartValidateCheckout', 1, function($vars) {
    ...
    if($vars['paymentmethod'] == $gatewayModuleName) {
        ...
        if (empty($gatewayParams['rtlo'])) {
            return [
                sprintf($dwLang['digiwallet']['error_missing_rtlo'], 'PaysafeCard'),
            ];
        }
    }
});